...
export default function Header() {
  return (
    <header className='flex justify-between items-center '>
      ...
      <div className='flex border border-gray-300 items-center rounded-full h-12 p-3 pl-5 pr-2 gap-5 shadow-md shadow-gray-300 transition duration-150 ease-out hover:shadow-gray-400 '>
        <div className='font-normal'>Anywhere</div>
        <div className="border-[1px] h-7 border-zinc-300 shadow-lg"></div>
        <div>Any week</div>
        <div className="border-[1px] h-7 border-zinc-300 shadow-lg"></div>
        <div className='text-slate-400'>Add guests</div>
        {/*Search icon*/}
